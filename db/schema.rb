...
ActiveRecord::Schema[7.2].define(version: 2026_08_19_015326) do
  ...
  create_table "boss_battles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["team_id", "boss_no"], name: "index_boss_battles_on_team_id_and_boss_no", unique: true
  ...
  create_table "players", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["team_id", "role", "email"], name: "index_players_on_team_role_email", unique: true
  ...
  create_table "questions", force: :cascade do |t|
    ...
    t.text "hint2"
    t.text "explanation"
    t.boolean "hints_enabled", default: true, null: false
  ...
  create_table "score_entries", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["team_id", "question_number"], name: "index_score_entries_on_team_id_and_question_number", unique: true
